...
Vue.prototype.api_url = 'https://api.leadfinder.live';
...
Vue.prototype.lead_statuses = [
  {name:'New', color:'#487cf7'},
  {name:'Follow Up', color:'#ffc107'},
  {name:'Client', color:'#4caf50'},
  {name:'Rejected', color:'#f44336'},
]
Vue.prototype.lead_statuse_color = {'New':'#487cf7', 'Follow Up':'#ffc107','Client':'#4caf50','Rejected':'#f44336'}
Vue.prototype.block_types = [
  {name:'Heading', icon:'/images/headers.png', block_style:{'font-family': 'lato', 'font-style': 'italic', 'font-weight': 500, 'font-size': '28px', 'text-align': 'center', 'color': '#000'}},
  {name:'Paragraph', icon:'/images/paragraph.png'},
  {name:'Image', icon:'/images/image.png'},
  {name:'Button', icon:'/images/button.png'},
  {name:'Social', icon:'/images/social.png'},
  {name:'Logo', icon:'/images/logo-icon.png'},
  {name:'Divider', icon:'/images/divider.png'},
  {name:'Spacer', icon:'/images/spacer.png'},
  {name:'Video', icon:'/images/video.png'},
  {name:'Background', icon:'/images/bg.png'},
]
...
Vue.mixin({
  ...
  mounted() {
    ...
    {
      if(localStorage.getItem("auth_token")!=''){
        this.$root.auth_token = localStorage.getItem("auth_token")
      }
    }
  },
  watch: {
  ...
  methods: {
    ...
    redirectTo(change_page){
      if(change_page=='email_marketing'){
        this.$router.push('/campaigns')
      }
      if(change_page=='crm'){
        this.$router.push('/leads')
      }
      if(change_page=='lead_finding'){
        location.href = '/maps.html'
      }
      if(change_page=='news'){
        this.$router.push('/news-letters')
      }
    },
    ...
    dateFormate(date,is_time=false,show='date'){
      if(!date){
        return ''
      }
      ...
      if(show=='time'){
        ...
        str = mydate.getDate()+' '+month + ' ' +mydate.getFullYear()+' '+time;
      }

      return str
    },
    timeFormate(time,is_time=true){
